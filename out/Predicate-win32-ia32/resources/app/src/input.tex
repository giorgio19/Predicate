...
\color{blue}Prove\ (3.13) \textbf{Negation of $\textit{false}$}: $\neg \textit{false} \equiv \textit{true}$\\
\color{blue}by showing equivalence to a previous theorem\\
\\

\underline{Proof}\\\\
\Step{\neg false}
\\$=$\>\>\ \ \ $\Gll$\ \text{ (3.8) Definition of false }\ $\Ggg$ \\
\Step{\neg \neg true}
...
\underline{Proof}\\\\
\Step{p \not \equiv q}
\\$=$\>\>\ \ \ $\Gll$\ \text{ (3.10) Definition of $\not \equiv$ }\ $\Ggg$ \\
\Step{\neg (p \equiv q)}
\\$=$\>\>\ \ \ $\Gll$\ \text{ (3.10) Distributivity of $\neg$ over $\equiv$ }\ $\Ggg$ \\
\Step{\neg p \equiv q}
\done
...
\color{blue}Prove\ (3.19) \textbf{Mutual interchangeability}: $p \not \equiv q \equiv r \ \ \equiv \ \ p \equiv q \not \equiv r$\\
\color{blue}by showing equivalence to a previous theorem\\
\\

\underline{Proof}\\\\
\Step{p \not \equiv q \equiv r}
\\$=$\>\>\ \ \ $\Gll$\ \text{ (3.10) Definition of $\not \equiv$ with \textit{p}, \textit{q} $:=$ \textit{p}, \textit{q} $\equiv$ r}\ $\Ggg$ \\
\Step{\neg (p \equiv q \equiv r)}
\\$=$\>\>\ \ \ $\Gll$\ \text{ (3.10) Definition of $\not \equiv$ with \textit{p}, \textit{q} $:=$ \textit{p} $\equiv$ \textit{q}, \textit{r} }\ $\Ggg$ \\
\Step{p \equiv q \not \equiv r}
\done
